...
#pragma region 描画初期化処理
    ...
    result = D3DCompileFromFile(
        L"Resources/シェーダー/BasicVS.hlsl",  // シェーダファイル名
        nullptr,
    ...
    // ピクセルシェーダの読み込みとコンパイル
    result = D3DCompileFromFile(
        L"Resources/シェーダー/BasicPS.hlsl",   // シェーダファイル名
        nullptr,
        D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
...
#pragma endregion
    ...
    while (true)
    {
       ...
       input->Update();
        ...
        // プリミティブ形状の設定コマンド
        dxCommon->GetCommondList()->IASetPrimitiveTopology(D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST); // 三角形リスト
        ...
        dxCommon->GetCommondList()->SetDescriptorHeaps(1, descHeaps);
